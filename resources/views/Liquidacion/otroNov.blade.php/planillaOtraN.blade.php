...
<form method="POST" action="{{ route('Liquidacion.agregarDocente') }}" >
        ...
        <a href="{{action('OtraNovedadController@ver')}}" target="blank" class="btn btn-secondary">Ver PDF</a>
        <a href="{{action('OtraNovedadControllerr@descargar')}}" class="btn btn-secondary">Descargar PDF</a>
